...
static const int systraypinningfailfirst = 1;   /* 1: pin systray to first monitor on fail */
static const int user_bh            = 0;
static const char *fonts[]          = {"JetBrainsMono Nerd Font:size=14", "monospace:size=12" };
